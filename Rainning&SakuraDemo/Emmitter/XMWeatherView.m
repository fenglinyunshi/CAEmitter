...
-(void)addSunnignEffect{
    ...
    //设置背景图片
    self.backgroundView.image=[UIImage imageNamed:@"img2.jpg"];
    ...
    //设置粒子内容
    emitterCell.contents=(__bridge id)([UIImage imageNamed:@"img1.png"].CGImage);
    
    //设置粒子缩放比例
    emitterCell.scale=0.01;
    
    //缩放范围
    emitterCell.scaleRange=0.15;
...
-(void)addRainningEffect{
    ...
    //设置粒子内容
    emitterCell.contents=(__bridge id)([UIImage imageNamed:@"42-Raindrop.png"].CGImage);
